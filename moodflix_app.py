...
def recommend_movies_by_mood(mood, model, le, mlb, df):
    ...
    def match_genres(genre_str):
        ...
        return any(predicted.lower()in genre_list for predicted in genres)
    ...
    # Ensure platform columns like 'Netflix', 'Hulu' etc. always exist
